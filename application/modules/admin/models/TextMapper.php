...
class Admin_Model_TextMapper extends My_Model_AdminMapper
{
	protected $_dbTable;
	protected $_options;
	...
	public function __construct(array $options = null)
	{
		...
		$options = array(
			'table'		=> 'Admin_Model_DbTable_Texts',
			'rowClass'	=> 'Admin_Model_Text'
		);
	...
	public function update( $new_data)
	{
		...
		if($old_data['owner_id'] != $new_data['owner_id'])
		{
	...
	public function getItems($offset, $itemCountPerPage)
	{
		...
		$select->from(array('a'=>'texts'))
		       ->joinLeft(array('u'=>'users'),'a.owner_id = u.id',array('username'))->where('a.state=1')
